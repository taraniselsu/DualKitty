...
namespace TMPro
{
    ...
    public class TMP_TextEventHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
    {
        [SerializeField] CreditsManager manager;
        ...
        void LateUpdate()
        {
            if (TMP_TextUtilities.IsIntersectingRectTransform(m_TextComponent.rectTransform, Input.mousePosition, m_Camera))
            {
                ...
                if (linkIndex != -1) {
                    ...
                    ourLinkID = linkInfo.GetLinkID();
                    ourLinkText = linkInfo.GetLinkText();
                    ourLinkIndex = linkIndex;

                    if (linkIndex != m_selectedLink)
                    {
        ...
        public void OnPointerClick(PointerEventData eventData) {
            ...
            manager.OnTMProLinkClick(ourLinkID, ourLinkText, ourLinkIndex);
        }
        ...
        private void SendOnLinkSelection(string linkID, string linkText, int linkIndex)
        {
            if (onLinkSelection != null) {
                // Debug.Log($"SendOnLinkSelection(\"{linkID}\", \"{linkText}\", \"{linkIndex}\")");
