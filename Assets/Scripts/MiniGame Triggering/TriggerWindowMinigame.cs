...
public class TriggerWindowMinigame : TriggerableMiniGame
{
    ...
    void Update()
    {
        ...
        if (loadingScene)
        {
            ...
            {
                SceneChanger.instance.LoadWindowScene();
            }
        }
    }
    ...
    public override void TriggerMinigame()
    {
        ...
        JamGameManager.instance.lastCatMinigame = LastCatMinigame.Window;
