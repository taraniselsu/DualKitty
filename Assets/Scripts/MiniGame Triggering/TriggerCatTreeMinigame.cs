...
public class TriggerCatTreeMinigame : TriggerableMiniGame
{
    [SerializeField] GameObject cuteCatClimbAnimation;

    float loadSceneTimer = 0.0f;
    float loadSceneTime = 2.0f;
    ...
    void Update()
    {
        ...
        if (loadingScene)
        {
            ...
            {
                SceneChanger.instance.LoadCatTreeScene();
            }
        }
    }
    ...
    public override void TriggerMinigame()
    {
        ...
        JamGameManager.instance.lastCatMinigame = LastCatMinigame.CatTree;
